...
public class ModularContainer extends Container {
	...
	public final ModularInventory inventory;
	...
	private static final int INV_START = ModularInventory.INV_SIZE;
	...
	// private static final int ARMOR_START = InventoryItem.INV_SIZE;
	// private static final int ARMOR_END = ARMOR_START+3;
	// private static final int INV_START = ARMOR_END+1;
	//and then carry on like above.

	public ModularContainer(EntityPlayer par1Player, InventoryPlayer inventoryPlayer, ModularInventory inventoryItem) {
		...
		for (i = 0; i < ModularInventory.INV_SIZE; ++i) {
	...
	public void writeToNBT() {
		...
		((ModularInventory) inventory).writeToNBT(this.containerstack.getTagCompound());
	}
